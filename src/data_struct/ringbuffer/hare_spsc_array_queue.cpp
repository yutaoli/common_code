#include "hare_spsc_array_queue.h"
...
extern hare_queue_offer_result_t hare_spsc_array_queue_offer(
    hare_spsc_array_queue_t *queue, void *element);

extern void *hare_spsc_array_queue_poll(hare_spsc_array_queue_t *queue);

extern size_t hare_spsc_array_queue_drain(
    hare_spsc_array_queue_t *queue, hare_queue_drain_func_t func, void *clientd, size_t limit);

extern size_t hare_spsc_array_queue_drain_all(
    hare_spsc_array_queue_t *queue, hare_queue_drain_func_t func, void *clientd);

extern size_t hare_spsc_array_queue_size(hare_spsc_array_queue_t *queue);
